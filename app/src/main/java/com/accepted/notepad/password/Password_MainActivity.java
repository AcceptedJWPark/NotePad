...
public class Password_MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnPw[10] = findViewById(R.id.btn_10);
        ...
        shape4.setColor(Color.parseColor("#66"+choosedColor4.substring(1)));
        ...
        {
            btnPw[i].setBackgroundColor(Color.parseColor(choosedColor4));
            final int finalI = i;
        ...
        ((ImageView)findViewById(R.id.iv_del_password)).setBackgroundColor(Color.parseColor(choosedColor4));
        ((ImageView)findViewById(R.id.iv_del_password)).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
    ...
    public void background(String color1, String color2, String color3, String color4){
        ...
        shape1.setColor(Color.parseColor("#66"+color2.substring(1)));
        ...
        ((RelativeLayout)findViewById(R.id.rl_container)).setBackgroundColor(Color.parseColor(color2));
